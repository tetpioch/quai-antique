...
catch(PDOException $pe)
{
    die('ERREUR : '.$pe->getMessage());
                  ...
                  <tbody>
                      <?php
                        ...
                        while($horaire = $statement3->fetch()) {
                            ...
                            echo '<td>'. $horaire['ouverture_midi'] . '</td>';
                            echo '<td>'. $horaire['fermeture_midi'] . '</td>';
                            echo '<td>'. $horaire['ouverture_soir'] . '</td>';
                            echo '<td>'. $horaire['fermeture_soir'] . '</td>';
                            echo '<td width=140>';
      ...
      function checkInput($data) {
        ...
        ?>             
        <div class="form-connection new_admin">
          ...
          <form action="#" method="POST">
                        ...
                        <div class="d-flex justify-content-center"><button type="submit" class="btn btn-primary btn-form">Modifier</button></div>
                    </form>
        </div>
    </body>
</html>
